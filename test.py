...
def test_manually_create_new_ship(mock_autoships, mock_grid):
...
def test_check_hit_or_miss():
    # Create a test scenario
    fired_block = (23, 3)
    opponents_ships_list = [[(23, 3), (23, 4),
                            (23, 5), (23, 6)],
                            [(22, 1), (21, 1), (20, 1)],
                            [(19, 10), (18, 10), (17, 10)],
                            [(20, 8), (20, 7)],
                            ...
                            [(24, 1)], [(17, 6)], [(18, 2)]]
    computer_turn = True
    opponents_ships_list_original_copy = [[(23, 3), (23, 4), (23, 5), (23, 6)],
                                          [(22, 1), (21, 1), (20, 1)],
                                          [(19, 10), (18, 10), (17, 10)],
                                          [(20, 8), (20, 7)],
                                          [(17, 4), (16, 4)],
    ...
    result = check_hit_or_miss(
        ...
        opponents_ships_list=opponents_ships_list,
        computer_turn=computer_turn,
        opponents_ships_list_original_copy=opponents_ships_list_original_copy,
        opponents_ships_set=opponents_ships_set,
        computer=computer,
    )
    # Assertions
    assert result is True
    assert opponents_ships_list == [[(23, 4), (23, 5), (23, 6)],
                                    [(22, 1), (21, 1), (20, 1)],
                                    [(19, 10), (18, 10), (17, 10)],
                                    [(20, 8), (20, 7)],
                                    [(17, 4), (16, 4)],
                                    [(25, 5), (25, 6)], [(24, 1)],
                                    [(17, 6)], [(18, 2)]]
    assert opponents_ships_set == {(20, 8), (17, 6),
                                   (16, 4), (22, 1),
                                   (18, 10), (20, 1),
                                   (20, 7), (21, 3),
                                   (23, 4), (23, 6),
...
def test_computer_shoots(mock_autoships, mock_grid):
...
def test_update_used_blocks():    # Create a test scenario
    ...
    update_used_blocks(ship=last_ship,
                       method=used_blocks_for_manual_drawing.discard)
    # Assertions
