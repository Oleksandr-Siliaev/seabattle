...
pygame.display.set_caption("Морскiй бiй")
...
def draw_grid():
    ...
    for y in range(11):
        ...
        if y < 10:
            ...
            screen.blit(letters_hor, (left_margin + y*block_size + (block_size//2 - letters_hor_width//2) +15*block_size, upper_margin + 10*block_size))
